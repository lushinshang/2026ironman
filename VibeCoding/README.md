...
> 📦 **5 天一循環的主題分類**：Day1-5＝個人寫作發布流程；Day6-10＝甲方招標文件版本管控（多次公告→分析差異避免重複評估規劃→AI 整理前去識別化→離線還原）。原本 Day2「PDF 轉 TXT/MD」、Day3「文字差異比對器」、Day4「文件去識別化工具」因主題重新分類，已分別搬移至現在的 Day6、Day7、Day9（`git mv`，內容與開發紀錄不變，各檔案已加註原編號）；空出來的 Day2～4 是新主題，尚待開發。

| Day | 主題 | 開發 | 撰文 | 連結 |
|:---:|---|:---:|:---:|---|
| 1 | 字數與段落統計器（100 題清單 #9） | ✅ 已完成，含離線下載功能 | ✅ 草稿與總編潤飾完成 | [工具](Day1/index.html) ・ [PRD](Day1/PRD.md) ・ [文章](Day1/article_draft.md) |
| 2 | ⬜ 中英文排版工具（100 題清單 #10，個人寫作發布流程第 2 步：排版整理） | ⬜ 待開發 | ⬜ 待開發 | — |
